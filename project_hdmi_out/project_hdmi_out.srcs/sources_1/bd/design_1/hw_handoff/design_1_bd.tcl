...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_pins clk_wiz_0/reset] [get_bd_pins rgb2dvi_0/aRst] [get_bd_pins rst_ps7_0_100M/mb_reset]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins v_tc_0/s_axi_aresetn]
